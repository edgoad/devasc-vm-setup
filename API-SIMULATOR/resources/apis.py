...
class Books(Resource):
    ...
    argParser.add_argument('includeISBN', type=inputs.boolean, help='Include in the results the ISBN numbers. Default=false')
    ...
    def get(self):
        ...
        parser.add_argument('includeISBN', type=inputs.boolean)
